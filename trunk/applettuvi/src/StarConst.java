...
interface StarConst
{
  ...
  public static final String[] strnam = { "Tí", "Suu", "Dàn", "Mao", "Thìn", "Ti", "Ngo", "Mui", "Thân", "Dau", "Tuát", "Hoi" };

  public static final String[] strcan = { "Giap", "Át", "Bính", "Dinh", "Mau", "Ky", "Canh", "Tân", "Nhâm", "Quí" };

  public static final String[] stramduong = { "Duong", "Âm" };
  ...
  public static final String[] strcuc = { "Thuy Nhi Cuc", "Moc Tam Cuc", "Kim Tu Cuc", "Tho Ngu Cuïc", "Hoa Luc cuc" };

  public static final String[] strsao = { "Tu vi", "Thien co", "Thai duong", "Vu khuc", "Thien dong", "Liem Trinh", "Thien phu", "Thai âm", "Tham lang", "Cu mon", "Thien tuong", "Thien luong", "Thát sat", "Pha Quân", "+Ta phu", "+Huu bat", "+Tam thai", "+Bat toa", "+Van xuong", "+Van khuc", "+Ân quang", "+Thien quy", "+Thai phu", "+Phong cao", "+Long trì", "+Phuong cat", "+Giai than", "+Thien khoi", "+Thien viet", "+Thien quan", "+Thien Phuc", "+Thien duc", "+Nguyet duc", "+Dao hoa", "+Hong loan", "+Thien hy", "+Thien tai", "+Thien tho", "-Thien thuong", "-Thien su", "-Thien khoc", "-Thien hu", "-Thien la", "-Dia võng", "-Co thàn", "-Qua tu", "-Thien hình", "+Thien y", "-Thien rieu", "+Thien ma", "+Hoa cai", "-Pha toai", "-Kiep sat", "-Dau quân", "+Thien tru", "+Van tinh", "-Luu ha", "+Thien giai", "+Dia giai", "-Hoa tinh", "-Linh tinh", "-Thai tue", "+Thieu duong", "-Tang mon", "+Thieu âm", "-Quan phu", "-Tu phu", "-Tue pha", "+Long duc", "-Bach Ho", "+Phuc duc", "-Dieu khach", "-Truc phu", "+Quan sach", "-Thien khong", "+Loc ton", "+Bac si", "+Luc si", "+Thanh long", "-Tieu hao", "-Tuong quân", "+Tau thu", "-Phi liem", "+Hy than", "-Benh phu", "-Dai hao", "-Phuc binh", "-Quan phu", "-Kình duong", "-Da la", "+Trang sinh", "-Moc duc", "-Quan dai", "+Lâm quan", "+De vuong", "-Suy", "-Benh", "-Tu", "-Mo", "-Tuyet", "-Thai", "+Duong", "-Dia kiep", "-Dia khong", "+Hoa loc", "+Hoa quyen", "+Hoa khoa", "-Hoa Ki", "+Duong phu", "+Quoc An" };
  ...
  public static final String[] strmenh = { "Hai trung kim", "Gian ha thuy", "Tích lich hoa", "Bích thuong tho", "Tang do moc", "Dai khe thuy", "Lo trung hoa", "Thanh dau tho", "Tung bach moc", "Kim bach kim", "Phu dang hoa", "Sa trung tho", "Dai lâm moc", "Bach lap kim", "Truong luu thuy", "Sa trung kim", "Thien ha thuy", "Thien thuong hoa", "Lo bang tho", "Duong lieu moc", "Tuyen trung thuy", "Son ha hoa", "Dai dich tho", "Thach luu moc", "Kiem phong kim", "Son dau hoa", "Oc thuong tho", "Bình dia moc", "Thoa xuyen kim", "Dai hai thuy" };

  public static final int[] nguhanhcung = { 2, 5, 3, 3, 5, 6, 6, 5, 4, 4, 5, 2 };
  public static final Color[] nguhanhcolor = { Color.black, new Color(0, 255, 0), Color.white, Color.yellow, Color.red, Color.black };
}